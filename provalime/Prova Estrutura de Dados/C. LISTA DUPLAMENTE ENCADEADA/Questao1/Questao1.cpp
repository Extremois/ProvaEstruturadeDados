...
int main(){
    ...
    cout << "MENU" << endl;
    cout << "==============================" << endl;
    cout << "1 - Inserir elementos em qualquer posição da lista" << endl;
    cout << "2 - Imprimir o conteudo da lista" << endl;
    cout << "3 - Buscar um elemento especifico na lista" << endl;
    cout << "4 - Exclusao de elementos em qualquer posiçao da lista" << endl;
    cout << "0 - Sair" << endl;
    cout << "==============================" << endl;
